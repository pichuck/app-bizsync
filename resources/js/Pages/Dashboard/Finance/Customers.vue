...
export default {
    ...
    methods: {
        ...
        handleCreateCustomer() {
            // Ganti route tujuan ke Edit.vue dengan parameter dummy
            this.$inertia.visit(route("customers.edit", "new"));
        },
        handleViewCustomer(customerId) {
            this.$inertia.visit(route("finance.customers.show", customerId));
        },
        handleEditCustomer(customerId) {
            this.$inertia.visit(route("finance.customers.edit", customerId));
        },
    ...
    <DashboardFinanceLayouts :user="user">
        <div class="container mx-auto px-4 py-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <Link
                    :href="route('finance.customers.create')"
